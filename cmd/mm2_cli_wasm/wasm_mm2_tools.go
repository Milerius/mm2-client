...
func main() {
	...
	//! Trading bot API
	js.Global().Set("start_simple_market_maker_bot_v1", startSimpleMarketMakerBot()) ///< start the simple trading bot
	js.Global().Set("stop_simple_market_maker_bot_v1", stopSimpleMarketMakerBot())   ///< stop the simple trading bot
